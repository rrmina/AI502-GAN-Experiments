...
def train():
    ...
    for epoch in range(1, NUM_EPOCHS+1):
        ...
        # Loss decay
        if (epoch == 100):
            a_optim = optim.Adam(a.parameters(), lr=A_LR/5, betas=[BETA_1, BETA_2])
            g_optim = optim.Adam(g.parameters(), lr=G_LR/5, betas=[BETA_1, BETA_2])
        ...
        with torch.no_grad():
            ...
            sample_images = scale_back(sample_images)
